...
namespace Final_Project.LoginsDataSetTableAdapters {
...
SELECT Username, Password FROM Logins WHERE (Username = @Username)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[3].CommandText = "SELECT Username, Password FROM dbo.Logins\r\nWHERE Username = @username";
        ...
        public virtual LoginsDataSet.LoginsDataTable GetDataByUsername(string paramUser) {
        ...
        public virtual int Search(LoginsDataSet.LoginsDataTable dataTable, string username, global::System.Nullable<int> password) {
            ...
            if ((password.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[1].Value = ((int)(password.Value));
            }
            else {
